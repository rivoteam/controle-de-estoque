...
from .views import homepage, lista_pedidos, detalhe_produto, detalhe_pedido, lista_produtos, user_logout, \
    modal_cria_pedido, modal_atualiza_pedido, modal_remove_pedido, modal_remove_produto, \
