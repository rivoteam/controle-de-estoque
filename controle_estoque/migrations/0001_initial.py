    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genero', models.CharField(choices=[('masculino', 'Masculino'), ('feminino', 'Feminino'), ('unissex', 'Unissex'), ('infantil', 'Infantil')], max_length=255)),
                ...
                ('tamanho', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='controle_estoque.tamanhoproduto')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('criado_em', models.DateTimeField(auto_now_add=True)),
                ('criado_por', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='hist_atual_preco_criado_por', to=settings.AUTH_USER_MODEL)),
                ('produto', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='hist_atual_preco_produto', to='controle_estoque.produto')),
            ],
            options={
